...
See [doc/future_directions.md](future_directions.md) for a detailed catalogue of
additional stress modes targeting different CPU subsystems (memory bandwidth, FPU/SIMD,
branch prediction, context switching, atomic contention, I/O syscall variety, mixed
workloads, and low-priority scheduling).
